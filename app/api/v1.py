...
from app.domains.assessments.router import router as assessment_router
from app.domains.auth.router import router as auth_router
from app.domains.company_addresses.router import router as company_address_router
from app.domains.culture_fit_templates.router import (
...
from app.domains.pre_assessment_templates.router import (
...
from app.domains.technical_assessment_templates.router import (
